// Choppe tous les bouttons de gauche => choppe tout les légume du jardin
const garden = document.querySelector(".mode-show")
const plusButtons = garden.querySelectorAll(".card-vege-icon");
