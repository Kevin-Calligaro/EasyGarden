...
print '>>>>>>>>>>>>>>create vegetables<<<<<<<<<<<<<<<<<<<<<'
  ...
  tomato = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/tomatoes_photo.png",
...
carrot = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/carrot_photo.png",
...
egg_plant = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/egg_plant_photo.png",
...
potato = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/potatos_photo.png",
...
radish = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/radish_photo.png",
...
pepper = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/pepper_photo.png",
...
onion = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/onion_photo.png",
...
cauliflower = Vegetable.create!(
    ...
    photo_vegetable: "photo-vege/cauliflower_photo.png",
...
broad_beans = Vegetable.create!(
    ...
    area: 40,
    description: "" ,
    photo_vegetable: "photo-vege/beans_photo.png",
...
zucchini = Vegetable.create!(
    ...
    area: 100,
    description: "",
    photo_vegetable: "photo-vege/zucchini_photo.png",
